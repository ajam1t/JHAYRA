            ...
            {step===3 && (
              <div>
                ...
                <div style={{textAlign:'center',marginTop:'.9rem'}}>
                  <a href={`https://wa.me/917070728989?text=Hi! I'd like to order the ${encodeURIComponent(template.title)} template (${selectedSize}, ${isPortrait?'Vertical':'Horizontal'}, ${actualSize}, ${selectedColour} PS Moulding, ${{ 'serif-italic':'Italic Serif','serif-bold':'Bold Serif','sans':'Sans-serif','classic':'Classic' }[textFont]} text).`}
