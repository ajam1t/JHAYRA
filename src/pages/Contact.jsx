...
export default function Contact() {
  ...
  return (
    <div data-page="contact">
      <SEO
        title="Contact JHAYRA | Get in Touch"
        description="Reach out to JHAYRA for custom orders, bulk enquiries & support. Chat with us on WhatsApp or send a message — we respond within 24 hours."
        path="/contact"
      />
