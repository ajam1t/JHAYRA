...
export default function About() {
  ...
  return (
    <div data-page="about">
      <SEO
        title="About JHAYRA | Personalized Photo Frames Brand India"
        description="Learn about JHAYRA — India's premium personalized photo frames and wall décor brand. Crafting memories into art with handcrafted frames, canvas prints & spiritual wall art."
        path="/about"
      />
        ...
        <section className="section">
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(200px,1fr))',gap:'2rem',marginTop:'2rem'}}>
            {[
              ...
              {name:'AJ',role:'IT Infrastructure & Developer Head'},
