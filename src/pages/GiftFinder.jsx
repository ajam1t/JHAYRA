...
export default function GiftFinder() {
  ...
  return (
    <div data-page="gift-finder">
      <SEO
        title="Personalized Gift Finder | JHAYRA"
        description="Find the perfect personalized photo frame gift for any occasion — birthday, wedding, anniversary, or just because. Let JHAYRA help you find the right frame."
        path="/gift-finder"
      />
