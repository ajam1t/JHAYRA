...
export default function Corporate() {
  ...
  return (
    <div data-page="corporate">
      <SEO
        title="Corporate Gifts | Bulk Photo Frame Orders | JHAYRA"
        description="JHAYRA offers premium corporate gifting solutions — personalized photo frames and wall art for employee gifts, events & bulk orders. Custom branding available."
        path="/corporate"
      />
      {/* Hero */}
