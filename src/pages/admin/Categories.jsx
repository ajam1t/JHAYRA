    ...
    <div>
      ...
      {form && (
        <div style={s.panel}>
          ...
          <div style={s.field}>
            <label style={s.label}>Slug <span style={{ textTransform: 'none', color: T.muted2 }}>(must match product category_slug)</span></label>
            <input
          ...
          <div style={s.field}>
            <label style={s.label}>Description <span style={{ textTransform: 'none', color: T.muted2 }}>(optional)</span></label>
            <textarea
            ...
            <tbody>
              {categories.map((cat, idx) => (
                <tr key={cat.id}>
                  ...
                  <td style={{ ...s.td, fontFamily: 'monospace', fontSize: '0.8rem', color: T.muted }}>{cat.slug}</td>
                  <td style={s.td}>{cat.name}</td>
                  <td style={{ ...s.td, color: T.muted }}>{counts[cat.slug] || 0}</td>
              ...
              {categories.length === 0 && (
                <tr><td style={{ ...s.td, textAlign: 'center', color: T.muted2 }} colSpan={6}>No categories yet. Add your first one.</td></tr>
              )}
            </tbody>
          </table>
        )}
